...
//        config.put("msg.with.table.name", "true");
//        config.put("enable.auto.commit", "true");
//        config.put("group.id","foo");
//        config.put("bootstrap.servers","localhost:6030");
//        TConsumer consumer = new TAOSConsumer(config);
//
////        config.setProperty(TMQConstants.MSG_WITH_TABLE_NAME, "true");
////        properties.setProperty(TMQConstants.ENABLE_AUTO_COMMIT, "true");
////        properties.setProperty(TMQConstants.GROUP_ID, "g1");
//
//
//
//
