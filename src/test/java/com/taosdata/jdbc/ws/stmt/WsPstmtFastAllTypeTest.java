...
public class WsPstmtFastAllTypeTest {
    private final String dbName = TestUtils.camelToSnake(WsPstmtFastAllTypeTest.class);
    ...
    @Test
    public void testExecuteUpdate_fastRoute_roundTripsAllTypes() throws SQLException {
        String sql = "insert into " + dbName + "." + tableName + " values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try (PreparedStatement statement = prepareFastStatement(sql)) {
    ...
    @Test
    public void testExecuteUpdate_fastRoute_roundTripsNulls() throws SQLException {
        String sql = "insert into " + dbName + "." + tableName + " values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try (PreparedStatement statement = prepareFastStatement(sql)) {
            long current = System.currentTimeMillis();
            statement.setTimestamp(1, new Timestamp(current));
    ...
    @Test
    public void testSetObject_fastRoute_roundTripsAllTypes() throws SQLException {
        String sql = "insert into " + dbName + "." + tableName + " values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try (PreparedStatement statement = prepareFastStatement(sql)) {
            long current = System.currentTimeMillis();
    ...
    @Test
    public void testSetObjectWithSqlType_fastRoute_roundTripsAllTypes() throws SQLException {
        String sql = "insert into " + dbName + "." + tableName + " values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try (PreparedStatement statement = prepareFastStatement(sql)) {
            long current = System.currentTimeMillis();
    ...
    @Test
    public void testSetObject_fastRoute_coercesBooleanAcrossNumericTypes() throws SQLException {
    ...
    @Test
    public void testSetObject_fastRoute_normalizesTemporalInputs() throws SQLException {
    ...
    @Test
    public void testExecuteCriticalValue_fastRoute() throws SQLException {
        String sql = "insert into " + dbName + "." + tableName + " values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try (PreparedStatement statement = prepareFastStatement(sql)) {
    ...
    public void testUtinyIntOutOfRange_fastRoute() throws SQLException {
        try (PreparedStatement statement = prepareFastStatement(unsignedSql())) {
            statement.setTimestamp(1, new Timestamp(0));
    ...
    @Test(expected = SQLException.class)
    public void testUtinyIntOutOfRange2_fastRoute() throws SQLException {
        try (PreparedStatement statement = prepareFastStatement(unsignedSql())) {
            statement.setTimestamp(1, new Timestamp(0));
    ...
    @Test(expected = SQLException.class)
    public void testUShortOutOfRange_fastRoute() throws SQLException {
        try (PreparedStatement statement = prepareFastStatement(unsignedSql())) {
            statement.setTimestamp(1, new Timestamp(0));
    ...
    @Test(expected = SQLException.class)
    public void testUShortOutOfRange2_fastRoute() throws SQLException {
        try (PreparedStatement statement = prepareFastStatement(unsignedSql())) {
            statement.setTimestamp(1, new Timestamp(0));
            statement.setShort(2, (short) 0);
    ...
    @Test(expected = SQLException.class)
    public void testUIntOutOfRange_fastRoute() throws SQLException {
        try (PreparedStatement statement = prepareFastStatement(unsignedSql())) {
            statement.setTimestamp(1, new Timestamp(0));
            statement.setShort(2, (short) 0);
    ...
    @Test(expected = SQLException.class)
    public void testUIntOutOfRange2_fastRoute() throws SQLException {
        try (PreparedStatement statement = prepareFastStatement(unsignedSql())) {
            statement.setTimestamp(1, new Timestamp(0));
            statement.setShort(2, (short) 0);
            statement.setInt(3, 0);
    ...
    @Test(expected = SQLException.class)
    public void testULongOutOfRange_fastRoute() throws SQLException {
        try (PreparedStatement statement = prepareFastStatement(unsignedSql())) {
            statement.setTimestamp(1, new Timestamp(0));
            statement.setShort(2, (short) 0);
            statement.setInt(3, 0);
    ...
    @Test(expected = SQLException.class)
    public void testULongOutOfRange2_fastRoute() throws SQLException {
        try (PreparedStatement statement = prepareFastStatement(unsignedSql())) {
            statement.setTimestamp(1, new Timestamp(0));
            statement.setShort(2, (short) 0);
            statement.setInt(3, 0);
    ...
    private PreparedStatement prepareFastStatement(String sql) throws SQLException {
        PreparedStatement statement = connection.prepareStatement(sql);
        Assert.assertTrue("Expected WSColumnFastPreparedStatement, got " + statement.getClass().getName(),
                statement instanceof WSColumnFastPreparedStatement);
        return statement;
    }
