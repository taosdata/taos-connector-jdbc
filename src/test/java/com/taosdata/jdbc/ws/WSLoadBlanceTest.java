...
public class WSLoadBlanceTest {
    ...
    private static final int portC = 9041;
    private final String db_name = TestUtils.camelToSnake(WSLoadBlanceTest.class);
    private static final String tableName = "meters";
    private Connection connection;
    private TaosAdapterMock taosAdapterMockB;
    private TaosAdapterMock taosAdapterMockC;
    @Description("query")
    @Test
    public void queryBlock() throws Exception  {
        ...
        if (url == null) {
            url = "jdbc:TAOS-WS://" + host + ":" + portB + "," + host + ":" + portC + "/?user=root&password=taosdata";
        } else {
    ...
    public void before() throws SQLException, InterruptedException, IOException, URISyntaxException {
        ...
        taosAdapterMockB = new TaosAdapterMock(portB);
        taosAdapterMockB.start();
        taosAdapterMockC = new TaosAdapterMock(portC);
        taosAdapterMockC.start();
