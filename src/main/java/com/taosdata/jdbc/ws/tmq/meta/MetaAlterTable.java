...
//                         // 11-add tag index, 13-update column compress, 14-add column with compress
//                         // 15-set multi tag (deprecated, replaced by 19), 16-alter column ref, 17-set ref null
//                         // 18-add column with ref, 19-alter tag with multi tables, 20-alter stable tag with filter
...
//          "where"                       // enable for alterType 20
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), alterType, colName, colNewName, colType, colLength, colValue, colValueNull,
                tags, encode, compress, level, refDbName, refTbName, refColName, tables, where);
    }
