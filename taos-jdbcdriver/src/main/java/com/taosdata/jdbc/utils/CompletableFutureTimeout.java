...
import com.taosdata.shaded.io.netty.util.HashedWheelTimer;
import com.taosdata.shaded.io.netty.util.Timeout;
import com.taosdata.shaded.io.netty.util.Timer;
import com.taosdata.shaded.io.netty.util.TimerTask;
...
public class CompletableFutureTimeout {
    ...
    private static <T> CompletableFuture<T>  handleShortTimeout(
        ...
        Timeout nettyTimeout = NETTY_TIMER.newTimeout(task, timeout, unit);
